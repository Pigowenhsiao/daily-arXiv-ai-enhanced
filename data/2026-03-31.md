...
### [2] [Beyond BMI: Smartphone Body Composition Phenotyping for Cardiometabolic Risk Assessment](https://arxiv.org/abs/2603.27017)
...
### [3] [Autonomous Agent-Orchestrated Digital Twins (AADT): Leveraging the OpenClaw Framework for State Synchronization in Rare Genetic Disorders](https://arxiv.org/abs/2603.27104)
...
### [4] [Quantitative mapping of dynamic 3D transport in growing cells via volumetric spatio-temporal image correlation spectroscopy (vSTICS)](https://arxiv.org/abs/2603.27484)
...
### [5] [Cardiovascular-Kidney-Metabolic Health: Insights from Wearables and Blood Biomarkers](https://arxiv.org/abs/2603.27787)
...
### [6] [Pan-Cancer Mapping of the Tumor Immune Landscape through Metagene Clustering and Predictive Modeling](https://arxiv.org/abs/2603.27145)
*Soham Chatterjee*
...
### [7] [Poisoning the Genome: Targeted Backdoor Attacks on DNA Foundation Models](https://arxiv.org/abs/2603.27465)
...
### [8] [PI-Mamba: Linear-Time Protein Backbone Generation via Spectrally Initialized Flow Matching](https://arxiv.org/abs/2603.26705)
*Tianyu Wu,Lin Zhu*
...
### [9] [Recent advances in modeling and simulation of biological phenomena in crowded and cellular environments](https://arxiv.org/abs/2603.26974)
...
### [10] [Information in a recurrent Retina-V1 network with realistic noise, feedback and nonlinearities](https://arxiv.org/abs/2603.27347)
...
### [12] [Energy Landscapes of Emotion: Quantifying Brain Network Stability During Happy and Sad Face Processing Using EEG-Based Hopfield Energy](https://arxiv.org/abs/2603.27644)
...
### [14] [A Normative Theory of Decision Making from Multiple Stimuli: The Contextual Diffusion Decision Model](https://arxiv.org/abs/2603.28600)
...
### [15] [When can fitness epistasis be ignored in a polygenic trait at equilibrium?](https://arxiv.org/abs/2603.27255)
