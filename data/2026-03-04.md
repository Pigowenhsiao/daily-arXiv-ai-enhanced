...
### [1] [Sparse autoencoders reveal organized biological knowledge but minimal regulatory logic in single-cell foundation models: a comparative atlas of Geneformer and scGPT](https://arxiv.org/abs/2603.02952)
*Ihor Kendiukhov*
...
### [2] [GPU-accelerated single-cell analysis at scale with rapids-singlecell](https://arxiv.org/abs/2603.02402)
...
### [3] [Fluctuating environments are sufficient to drive substantial variability in species abundance across locations](https://arxiv.org/abs/2603.02403)
...
### [4] [Recombination Rate Modifiers under Stochastic Transmission](https://arxiv.org/abs/2603.02496)
...
### [5] [Mathematical model of tumor-macrophage interactions: Elucidating the tumor-driven macrophage phenotype reprogramming](https://arxiv.org/abs/2603.02757)
...
### [6] [Fast and Versatile RNA Design via Motif-level Divide-and-Conquer and Structure-level Rival Search](https://arxiv.org/abs/2603.02283)
...
### [7] [A Benchmark Analysis of Graph and Non-Graph Methods for Caenorhabditis Elegans Neuron Classification](https://arxiv.org/abs/2603.02241)
...
### [8] [Understanding Decision-Making Across the Lifespan Needs Theoretical Neuroscience](https://arxiv.org/abs/2603.02461)
...
### [9] [Topological bounds on the dynamical growth rate of chemical reaction networks](https://arxiv.org/abs/2603.02627)
...
### [10] [Contextual Invertible World Models: A Neuro-Symbolic Agentic Framework for Colorectal Cancer Drug Response](https://arxiv.org/abs/2603.02274)
...
### [11] [Stochastic modeling of long-legged ant A. gracilipes locomotion in laboratory experiments](https://arxiv.org/abs/2603.02665)
