...
### [1] [INTENSE: Detecting and disentangling neuronal selectivity in calcium imaging data](https://arxiv.org/abs/2603.04622)
...
### [2] [A systematic approach to answering the easy problems of consciousness based on an executable cognitive system](https://arxiv.org/abs/2603.04440)
*Qi Zhang*
...
### [3] [Why the Brain Consolidates: Predictive Forgetting for Optimal Generalisation](https://arxiv.org/abs/2603.04688)
...
### [4] [Neural geometry in the human hippocampus enables generalization across spatial position and gaze](https://arxiv.org/abs/2603.04747)
...
### [5] [The Spatial and Temporal Resolution of Motor Intention in Multi-Target Prediction](https://arxiv.org/abs/2603.05418)
...
### [6] [AbAffinity: A Large Language Model for Predicting Antibody Binding Affinity against SARS-CoV-2](https://arxiv.org/abs/2603.04480)
